...
<div id="contentContainer" class="p-5 md:px-20 gap-y-20 mt-8 shadow-md">
    ...
    <table class="min-w-full table-auto text-left border-collapse border-slate-900 bg-white shadow-md rounded-lg">
        ...
        <tbody>
            <tr>
                <td class="border border-slate-900 p-4">{{ $admin->first_name }}</td>
                <td class="border border-slate-900 p-4">{{ $admin->last_name }}</td>
                <td class="border border-slate-900 p-4">{{ $admin->username }}</td>
                <td class="border border-slate-900 p-4">{{ $admin->email }}</td>
                <td class="border border-slate-900 p-4">{{ $admin->phoneNo }}</td>
            </tr>
        </tbody>
    </table>
